...
WV_S32  HIS_VENC_Init(WV_S32  vencChn, WV_S32 rcMode,WV_S32 Profile,WV_U32  width,WV_U32  height,WV_U32  srcFrmRate ,WV_U32  dstFrmRate,WV_U32  bitRate )
{
   ...
   //    step 1:  Create Venc Channel
            ...
            stH264Attr.u32MaxPicWidth  = stPicSize.u32Width;//HIS_SYS_MAX_PICWIDTH;//stPicSize.u32Width;
            stH264Attr.u32MaxPicHeight = stPicSize.u32Height;//HIS_SYS_MAX_PICHEIGH;//stPicSize.u32Height;
            stH264Attr.u32PicWidth     = stPicSize.u32Width;/*the picture width*/
            stH264Attr.u32PicHeight    = stPicSize.u32Height;/*the picture height*/
            stH264Attr.u32BufSize      = stPicSize.u32Width * stPicSize.u32Height *2;//HIS_SYS_MAX_PICWIDTH * HIS_SYS_MAX_PICHEIGH * 2;/*stream buffer size*/
            ...
            if(0 == rcMode)
            {
                ...
                stH264Cbr.u32Gop            =  dstFrmRate*10;
                stH264Cbr.u32StatTime       =  10; /* stream rate statics time(s) */
            ...
            else if (1 == rcMode) 
            {
                ...
                stH264FixQp.u32IQp = 23;//10;
                stH264FixQp.u32PQp = 20;//10;
                memcpy(&stVencChnAttr.stRcAttr.stAttrH264FixQp, &stH264FixQp,sizeof(VENC_ATTR_H264_FIXQP_S));
            }
            else if (2 == rcMode) 
            {
                stVencChnAttr.stRcAttr.enRcMode = VENC_RC_MODE_H264VBR;
                stH264Vbr.u32Gop = dstFrmRate*10;
                stH264Vbr.u32StatTime = 10;
...
WV_S32  HIS_VENC_SetResolution(WV_S32  vencChn,WV_U32 width,WV_U32  height ,WV_U32  srcFrmRate ,WV_U32  dstFrmRate,WV_U32  bitRate )
{
  ...
  s32Ret = HI_MPI_VENC_SetChnAttr(vencChn,&stVencChnAttr);
    if (HI_SUCCESS != s32Ret)
    {
       WV_ERROR("HI_MPI_VENC_SetChnAttr vechn[%d] failed with %#x!\n",vencChn, s32Ret);
        return HI_FAILURE;
    }  
    //setp 3
#if 1
	...
	if (HI_SUCCESS != s32Ret)
    {
       WV_ERROR("HI_MPI_VENC_StartRecvPic vechn[%d] failed with %#x!\n",vencChn, s32Ret);
        return HI_FAILURE;
    }
#endif
 	return WV_SOK;
