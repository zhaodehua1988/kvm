...
WV_S32  WV_UDPRX_Creat(WV_ETH_UDP_RX_E *pDev)
{
	...
	nSendBufLen = 0;
    getsockopt(pDev->socketHndl, SOL_SOCKET, SO_RCVBUF,(char*)&nSendBufLen, &optlen); 
	if((nSendBufLen/2) !=  WV_COMM_UDPRX_BUF_MAXLEN)
	{
...
************************************************/
WV_S32  WV_UDPRX_Rx(WV_ETH_UDP_RX_E *pDev,WV_U8 *pBuf, WV_S32 *len) 
{
